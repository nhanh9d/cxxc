...
export default function PhoneScreen() {
  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        {/* Custom Header */}
        {step === accountSteps.finish || <ThemedView style={styles.header} lightColor="#FFFCEE" darkColor="#2B2A27">
          <ThemedButton
            textStyle={{
              color: "#8A8A8E",
            ...
            onPress={() => {
              if (router.canGoBack()) {
                ...
                router.push("/"); // Fallback to the home or login screen
              }
            }}
            icon={<IconSymbol name="arrow.backward.circle" color={"#8A8A8E"} />}
          />
        </ThemedView>}
